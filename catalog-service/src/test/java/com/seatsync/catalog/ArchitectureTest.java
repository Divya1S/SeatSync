 ...
 */
@AnalyzeClasses(packages = "com.seatsync.catalog", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    ...
    /** Rule 2: only DTOs at the edge — no JPA entities in or out of the web package. */
    @ArchTest
    ...
    static final ArchRule mustNotImportOtherSeatSyncServices =
            noClasses().should().dependOnClassesThat().resideInAnyPackage(
                    ...
                    .because("catalog-service must not import another SeatSync service's packages (§8.1 rule 4)");
}
